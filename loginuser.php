			...
			<div class="row">
				<div class="col-12">
					<div class="site-navbar">
						<a href="index.html" class="site-logo"><img src="img/logo0.jpg" alt=""></a>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 footer-widget">
					...
					<h5 class="fw-title">CONTACT US</h5>
						...
						<p><i class="fa fa-phone"></i>0788274248</p>
						<p><i class="fa fa-envelope"></i>ngabonzizagordon48@gmail.com</p>
				...
				<div class="col-lg-3 col-md-6 footer-widget">
					<div class="double-menu-widget">
						...
						<ul>
							...
							<li><a href="">RUBIRIZI</a></li>
							<li><a href="">KABEZA</a></li>
							<li><a href="">BUSANZA</a></li>
						</ul>
						<ul>
							<li><a href="">CYIBAGABAGA</a></li>
							<li><a href="">KIMIRONKO</a></li>
							<li><a href="">NYAMATA</a></li>
							<li><a href="">GISOZI</a></li>
							<li><a href="">KAGUGU</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-6  footer-widget">
